...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/blog`, lastModified: CONTENT_UPDATED, changeFrequency: 'weekly', priority: 0.75 },
    { url: `${base}/guides`, lastModified: CONTENT_UPDATED, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${base}/financing`, lastModified: CONTENT_UPDATED, changeFrequency: 'monthly', priority: 0.75 },
    {
      url: `${base}/financing/deferred-interest-trap`,
      lastModified: CONTENT_UPDATED,
