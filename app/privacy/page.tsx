...
export const metadata = pageMetadata({
  ...
  description:
    'How GeneratorInstallerList handles contact form submissions and site analytics.',
  path: '/privacy',
})
    ...
    <>
      ...
      <article className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-10">
        ...
        <p className="t-body mt-6 text-[19px]">
          GeneratorInstallerList is an independent research directory. This page
        ...
        <div className="prose-content mt-10">
          ...
          <p>
            ...
            what those sites collect when you leave GeneratorInstallerList.
          </p>
